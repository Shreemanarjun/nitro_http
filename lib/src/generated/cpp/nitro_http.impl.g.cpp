// Generated by Nitrogen — edit this file to implement NitroHttpNative.
//
// This file is a one-time starter: Nitrogen will NOT overwrite it.
// Rename it to e.g. "NitroHttpNativeImpl.cpp" and add it to CMakeLists.txt.
//
// Quick-start:
//   1. Implement each TODO method below.
//   2. Add this file to your CMakeLists.txt (target_sources).
//   3. Call nitro_http_register_impl(&myImpl) during plugin/app init.
//   4. Call nitro_http_register_impl(nullptr) in teardown.
//
